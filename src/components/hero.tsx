function Hero() {
  ...
  return (
    <section
      id="home"
      className="justify-center items-start md:items-center gap-2 grid md:grid-cols-2 md:grid-rows-1 bg-blue-800 px-4 pt-24 md:pt-32 pb-16 md:pb-0 md:h-screen min-h-96"
    >
      <div className="md:mb-0 text-container md:text-left text-center mb:4">
        ...
        <p className="py-4">Building modern, responsive, and user-friendly web experiences</p>
