function Hero() {
  ...
  return (
    <section className="justify-center items-start gap-4 grid md:grid-cols-2 md:grid-rows-1 bg-gray-800 px-4 pt-24 md:pt-56 pb-16 md:pb-0 md:h-screen min-h-96">
