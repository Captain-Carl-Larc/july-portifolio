function Hero() {
  ...
  return (
    <section id="home" className="justify-center items-start md:items-center gap-2 grid md:grid-cols-2 md:grid-rows-1 bg-blue-800 px-4 pt-24 md:pt-32 pb-16 md:pb-0 md:h-screen min-h-96">
